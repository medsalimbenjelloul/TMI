...
if ($_GET != array()) {
    ...
    if ($action == "edit" || $action == "view") { // GET DATA FOR EDIT AND VIEW
        $event = (new EventDB())->searchData( array("id"=>$_GET["id"]) );
                        ...
                        <form action="adm_event.php" method="post">
                           <!-- event -->
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="iname" name="name" value="<?php echo ($action=="view" || $action=="edit") ? $event->getName() : ""; ?>" <?php echo ($action=="view") ? "readonly" : ""; ?> required>
                                </div>
                            </div>
                            <div class="form-group row">
...
&nbsp;&nbsp;&nbsp;&nbsp;
                                        <div class="row" id="wrap">
                                            <div class="col-sm-5">
                                                <select name="from[]" id="multiselect1" class="form-control" size="8" multiple="multiple">
                                                     <?php
                                                    $list = (new EventDB())->listarExponentes();
                                                    $n = 0;
                                                    if ($list != array()) {
                                                        foreach ($list as $row) {
                                                            $n = $n + 1;
                                                            ?>
                                                    <option value="<?php echo $row->getId_person()?>"><?php echo $row->getFirst_surname(); echo " "; echo $row->getSecond_surname(); ?> </option>
                                                    <?php
                                                        }
                                                    }
                                                        ?>
                                            ...
                                            <div class="col-sm-5">
                                                <select style="width: 143px; overflow: scroll;" name="to[]" id="multiselect1_to" class="form-control" size="8" multiple="multiple"></select>
                                            </div>
                                        </div>
                                 ...
                                 <label for="person" class="col-sm-2 col-form-label">Asignar asistentest </label>
