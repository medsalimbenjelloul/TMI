                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarText">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="<?php echo VIEW_URL;?>ctrl_sessions_list.php">Inicio <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo VIEW_URL;?>ctrl_sessions_list.php">Eventos y Sesiones</a>
                        </li> 
                        <?php
                        }
                        ?>
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <a class="dropdown-item" href="ctrl_user_profile.php?action=view">Perfil</a>
