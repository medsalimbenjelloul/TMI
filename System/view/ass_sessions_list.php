                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="width:140px">
                                        <a href="<?php echo VIEW_URL;?>ass_assistance_report.php?action=delete" title="Ver lista de asistencia a la sesión" class="btn btn-danger btn-sm"><i class="fas fa-users"></i> Ver Asistencia</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
