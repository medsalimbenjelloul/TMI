                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="width:150px">
                                        <a href="<?php echo VIEW_URL;?>ctrl_take_photo.php?action=edit" title="Tomar una foto de la sesión" class="btn btn-primary btn-sm"><i class="fas fa-camera-retro"></i> Foto de sesión</a>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
