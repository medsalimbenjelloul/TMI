...
// Add final session
       $date = date("Y-m-d H:i:s");;
        $id_session = (new SessionDB())->insertData(array("name" => $_POST["name"], "detail" => $_POST["detail"],
            "when_datetime" => $date["when_datetime"],"id_event"=>$_POST["id_event"], "id_company" => $actual_user->getId_company(), "last_user" => $actual_user->getId_user()));
