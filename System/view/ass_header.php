                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarText">
                    <ul class="navbar-nav">  
                        ...
                        <li class="nav-item active">
                            <a class="nav-link" href="<?php echo VIEW_URL;?>ass_sessions_list.php">Inicio <span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="<?php echo VIEW_URL;?>ass_sessions_list.php">Sesiones</a>
                        </li> 
                        <?php
                        }
                        ?>
