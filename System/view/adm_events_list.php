                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                   <a href="<?php echo VIEW_URL; ?>adm_event.php?action=edit&id=<?php echo $row->getId_event(); ?>" title="Editar" class="btn btn-primary btn-sm"><i class="far fa-edit m-1">
                                                    ...
                                                    <a href="<?php echo VIEW_URL; ?>adm_event.php?action=delete&id=<?php echo $row->getId_event(); ?>&name=<?php echo $row->getName(); ?>" title="Eliminar" class="btn btn-danger btn-sm" onclick="return confirm('¿Esta seguro de borrar el usuario <?php echo $row->getName(); ?>?')"><i class="fas fa-trash-alt m-1">
