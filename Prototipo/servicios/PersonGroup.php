...
<html lang="en">
  ...
  <body>
	<div class="container">
		<h1 class="text-center">CREACION DE LA EMPRESA</h1>
		...
		echo "<div class='border rounded'><strong>Empresa creada: </strong><em>".$_SESSION["company"]."</em></div><br/>";
		...
		try
		{
			...
			echo "<pre class='border rounded'>" . $json . "</pre>";
		}
